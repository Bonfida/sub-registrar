...
export class deleteSubrecordInstruction {
  tag: number;
  ...
  serialize(): Uint8Array {
    return serialize(deleteSubrecordInstruction.schema, this);
  }
  getInstruction(
    programId: PublicKey,
    registrar: PublicKey,
    ...
    [
      editRegistrarInstruction,
      {
        ...
        fields: [
          ...
          ["newMint", { kind: "option", type: [32] }],
          ["newFeeAccount", { kind: "option", type: [32] }],
          ["newPriceSchedule", { kind: "option", type: [["u64"]] }],
          ["newMaxNftMint", { kind: "option", type: "u8" }],
        ],
      },
    ],
  ]);
...
export class registerInstruction {
  ...
  getInstruction(
    ...
    nameAuctioningProgram: PublicKey,
